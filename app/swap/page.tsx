      ...
      <div className="w-full bg-swap relative bg-cover bg-no-repeat min-h-screen">
        <AnimatedContainer className="w-full flex items-center justify-center flex-col">
          ...
          <div className="w-[80%] flex flex-col rounded-[50px] gap-20 bg-[#D9D9D91A] px-10 my-20 py-8">
            ...
            <div className="flex flex-col pt-20 md:pt-0 lg:flex-row items-start lg:items-center justify-between gap-10 lg:gap-20">
              <div className="max-w-[256px] md:max-w-[427px] flex flex-col">
                <h1 className="font-gravesend font-bold text-[40px] leading-[32px] lg:text-6xl lg:leading-[56px] tracking-tighter uppercase">
                  Swap concluído,{" "}
                  <span className="font-scandia font-light text-3xl lg:text-[58px] lg:leading-[60px]">
                    com sucesso
                  </span>
                </h1>

                <div className="flex items-center mt-5 md:mt-0 justify-start lg:justify-end">
                  <Button
                    variant="outline"
